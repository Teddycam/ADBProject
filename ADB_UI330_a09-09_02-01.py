...
##########################
procdata = [[],] * 15                                      # array of returned ADB strings with data
'''
...
def red_text(txt):
    rText = f"<span style=\"  font-weight:600; color:#800000;\" >"
    rText += txt + "</span>"
    return rText


def grn_text(txt):
    grnText = f"<span style=\"  font-weight:600; color:#008000;\" >"
    grnText += txt + "</span>"
    return grnText


def blk_text(txt):
    bText = f"<span style=\" font-weight:450; color:#000000;\" >"
    bText += txt + "</span>"
    return bText
...
def get_radio_modules_qty():
    ...
    '''
    global devdata
    # a = torun + 'shell "dumpsys telephony.registry |grep ' + "'" + 'Phone Id=' + '\47\42'
    ...
    def append_records_lst_l1(self):
        ...
        for row in range(len(lst_l1)):
            if ('OUT_OF_SERVICE' in lst_l1[row]
                ...
                self.textEdit_1.append(red_text(lst_l1[row]))
            elif 'IN_SERVICE' in lst_l1[row]:
                self.textEdit_1.setTextBackgroundColor(self.lightgreenColor)
                self.textEdit_1.append(grn_text(lst_l1[row]))
            else:
                self.textEdit_1.setTextBackgroundColor(self.whiteColor)
                self.textEdit_1.append(blk_text(lst_l1[row]))
            # self.textEdit_1.append(lst_l1[row])
        self.textEdit_1.verticalScrollBar().setValue(0) # OK
        # self.textEdit_1.verticalScrollBar().minimum() # NOK
        # self.textEdit_1.verticalScrollBar().maximum() # NOK
        # self.textEdit_1.moveCursor(QTextCursor.Start) # NOK
    ...
    def append_records_lst_l2(self):
        ...
        for row in range(len(lst_l2)):
            ...
            or 'POWER_OFF' in lst_l2[row]):
                ...
                self.textEdit_2.append(red_text(lst_l2[row]))
            elif 'IN_SERVICE' in lst_l2[row]:
                self.textEdit_2.setTextBackgroundColor(self.lightgreenColor)
                self.textEdit_2.append(grn_text(lst_l2[row]))
            else:
                self.textEdit_2.setTextBackgroundColor(self.whiteColor)
                self.textEdit_2.append(blk_text(lst_l2[row]))
            # self.textEdit_2.append(lst_l2[row])
        self.textEdit_2.verticalScrollBar().setValue(0) #OK
        # self.textEdit_2.verticalScrollBar().minimum() # NOK
        # self.textEdit_2.verticalScrollBar().maximum() # NOK
        # self.textEdit_2.moveCursor(QTextCursor.Start) # NOK
